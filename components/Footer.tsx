      ...
      <div className="mx-auto max-w-[1440px] px-gutter pt-20 pb-12 lg:pt-28 lg:pb-16">
        <div className="grid grid-cols-1 gap-y-14 lg:grid-cols-12 lg:gap-x-8">
          <div className="lg:col-span-6">
            <Link href="/" className="inline-flex" aria-label="Wooster Prep home">
            ...
            <ul className="flex flex-col gap-4">
              {links.map((l) => (
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="inline-flex min-h-8 items-center text-body text-paper-muted underline decoration-paper-muted/50 underline-offset-4 transition-colors duration-(--duration-fast) ease-out hover:text-paper hover:decoration-paper"
                  >
                    {l.label}
                  </Link>
                </li>
